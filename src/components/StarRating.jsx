      ...
      <div style={starContainer}>
        {Array.from({ length: maxStars }, (_, i) => (
          <Star
            ...
            onHover={() => handleOnHover(i + 1)}
            isFull={hover ? hover >= i + 1 : rating >= i + 1}
            onLeave={() => handleOnHover(0)}
            style={{ color, size }}
          />
        ))}
      </div>
...
function Star({ onRate, isFull, onHover, onLeave, style }) {
  const star = {
